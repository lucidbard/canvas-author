...
def create_page_frontmatter(
    ...
    Args:
        title: Page title
        url: Page URL slug (Canvas-generated from title)
    ...
    Note:
        The 'canvas_url' field is the URL generated by Canvas from the title.
        Canvas does not allow custom URLs - they are always derived from the title.
    """
    metadata = {
        "title": title,
        "canvas_url": url,  # Canvas-generated URL (derived from title)
        "course_id": course_id,
        "published": published,
